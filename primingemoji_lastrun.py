...
expName = 'primingemoji'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Admin\\Desktop\\emotion_research\\primingemoji_lastrun.py',
...
slider = visual.Slider(win=win, name='slider',
    ...
    labels=["Positive", "Neutral", "Negetive"], ticks=(1, 2, 3), granularity=0.0,
...
trials = data.TrialHandler(nReps=1.0, method='random', 
    ...
    trialList=data.importConditions('C:/Users/Admin/Desktop/emotion_research/emotionproject.xlsx'),
...
for thisTrial in trials:
    ...
    image.setImage(prime)
    image_2.setImage(test)
    slider.reset()
    # keep track of which components have finished
    trialComponents = [image, image_2, slider]
